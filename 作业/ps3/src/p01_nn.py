...
def example_weights():
    ...
    w['hidden_layer_0_1'] = 0.0
    w['hidden_layer_1_1'] = 0.0
    w['hidden_layer_2_1'] = 0.0
    w['hidden_layer_0_2'] = 0.0
    w['hidden_layer_1_2'] = 0.0
    w['hidden_layer_2_2'] = 0.0
    w['hidden_layer_0_3'] = 0.0
    w['hidden_layer_1_3'] = 0.0
    w['hidden_layer_2_3'] = 0.0

    w['output_layer_0'] = 0.0
    w['output_layer_1'] = 0.0
    w['output_layer_2'] = 0.0
    w['output_layer_3'] = 0.0
